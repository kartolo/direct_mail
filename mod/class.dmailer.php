 ...
 *
 *
 *  This class has been moved from t3lib to the direct_mail extension.
 */
/**
...
//			debug('->'.$recipRow['uid'],1);
	...
	function dmailer_setBeginEnd($mid,$key)	{
        ...
        //[ToDo] I think this should be configurable where this mail goes.
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/direct_mail/class.dmailer.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/direct_mail/class.dmailer.php']);
}
?>
