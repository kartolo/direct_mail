...
$LOCAL_LANG = Array (
	'default' => Array (
		...
		'sys_dmail.priority.I.1' => 'Normal',
		'sys_dmail.priority.I.2' => 'High',
		'sys_dmail.sendOptions' => 'Format of mail content:',
		'sys_dmail.sendOptions.I.0' => 'Plain text',
		'sys_dmail.sendOptions.I.1' => 'HTML',
		'sys_dmail.includeMedia' => 'Include images and other media in HTML content:',
		'sys_dmail.flowedFormat' => 'Use flowing text format in plain text content:',
		...
		'sys_dmail.plainParams.ALT.1' => 'URL for plain text content:',
	...
	'de' => Array (
		...
		'sys_dmail.long_link_mode' => 'Nicht nur Links länger als 76 Zeichen, sondern ALLE Links:',
	...
	'fr' => Array (
		...
		'sys_dmail_category.old_cat_number' => 'Ancien numéro de rubrique:',
		'sys_dmail' => 'Bulletin',
		'sys_dmail.subject' => 'Sujet:',
		'sys_dmail.page' => 'Page de bulletin:',
		'sys_dmail.from_email' => 'Adresse électronique de l\'auteur:',
		'sys_dmail.from_name' => 'Prénom et nom de l\'auteur:',
		'sys_dmail.replyto_email' => 'Adresse électronique de réponse:',
		'sys_dmail.replyto_name' => 'Prénom et nom de réponse:',
		'sys_dmail.return_path' => 'Chemin de retour:',
		'sys_dmail.organisation' => 'Organisation:',
		'sys_dmail.transfer_encoding' => 'Encodage de transfert de contenu:',
		'sys_dmail.charset' => 'Encodage de caractères du message:',
		'sys_dmail.priority' => 'Priorité:',
		'sys_dmail.priority.I.0' => 'Basse',
		'sys_dmail.priority.I.1' => 'Normale',
		'sys_dmail.priority.I.2' => 'Haute',
		'sys_dmail.sendOptions' => 'Format du contenu des messages:',
		'sys_dmail.sendOptions.I.0' => 'Texte simple',
		'sys_dmail.sendOptions.I.1' => 'HTML',
		'sys_dmail.includeMedia' => 'Inclure les images et autres média dans le contenu HTML:',
		'sys_dmail.flowedFormat' => 'Utiliser le format sans retour à la ligne dans le contenu texte simple:',
		'sys_dmail.HTMLParams' => 'Paramètres, HTML:',
		'sys_dmail.plainParams' => 'Paramètres, Texte simple:',
		'sys_dmail.issent' => 'Est envoyé:',
		'sys_dmail.use_domain' => 'Domaine des liens internes:',
		'sys_dmail.use_rdct' => 'Rediriger les liens de plus de 76 caractères de longueur:',
		'sys_dmail.long_link_rdct_url' => 'Url de redirection des liens longs:',
		'sys_dmail.long_link_mode' => 'Rediriger non seulement les liens de plus de 76 caractères, mais TOUS les liens:',
		...
		'sys_dmail.plainParams.ALT.1' => 'URL pour le contenu de format texte simple:',
		'sys_dmail.HTMLParams.ALT.1' => 'URL pour le contenu de format HTML:',
		'sys_dmail.authcode_fieldList' => 'Champs utilisés dans le calcul des codes d\'authentification:',
		...
		'sys_dmail_group.type.I.3' => 'Requête spéciale',
		...
		'sys_dmail_group.whichtables.I.2' => 'Table définie sur mesure',
		...
		'sys_dmail_group.csv.I.1' => 'CSV [name],[email]',
		'sys_dmail_group.select_categories' => 'Doit être abonné aux rubriques:',
	),
	'es' => Array (
		'sys_dmail' => 'Boletín',
		'sys_dmail.subject' => 'Asunto:',
		'sys_dmail.page' => 'Página de boletín:',
		'sys_dmail.from_email' => 'Direccíon del remitente:',
		'sys_dmail.from_name' => 'Nombre del remitente:',
		'sys_dmail.replyto_email' => 'Direccíon de respuesta:',
		...
		'sys_dmail.long_link_rdct_url' => 'Url de vínculo RDCT:',
		'sys_dmail.long_link_mode' => 'No solo vínculos más extensos de 76 caracteres sino TODOS los vínculos:',
