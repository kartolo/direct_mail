		...
		if (!$TYPO3_DB->sql_num_rows($res))	{
			...
			while($row = $TYPO3_DB->sql_fetch_assoc($res))	{
				$outLines[] = array(
					...
					'<a href="#" onClick="'.t3lib_BEfunc::viewOnClick($row['uid'],$BACK_PATH).'"><img src="../res/gfx/preview_html.gif" width="16" height="16" alt="" style="vertical-align:top;" title="'.$LANG->getLL('nl_viewPage_HTML').'"/></a>',
